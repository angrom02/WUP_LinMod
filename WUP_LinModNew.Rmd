...
print(anova_result) 
```
The p-value is 0.00000499 less than 0.05 therefore we reject the null hypothesis. Model 1 and model 3are different. The models are significantly different, therefore we can conclude that Model 3 is better. 
...
The p-value is 0.0000149 which is less than 0.05 therefore we reject the null hypothesis. Model 2 and Model 3 are significantly different and we can conclude that model 3 is better.  
